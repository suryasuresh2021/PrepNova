...
correct_option is the 0-based index into options. explanation is a short (1-2 sentence) reason the
correct answer is right, shown to students after they submit — also use $...$ for math in it.`;
